...
function PublicRoute({ children }) {
  ...
  useEffect(() => {
    ...
    if (isReturningFromPayment === "true") {
      ...
      console.log(
        "No se detectó retorno de pago, bandera es:",
  ...
  if (loadingAuth) {
    ...
    return (
      <main style={{ padding: "4rem", textAlign: "center" }}>Cargando...</main>
    );
  }
  ...
  // Si se pasó `children` (uso como wrapper), renderizarlos; si no, dejar Outlet (uso como ruta padre)
