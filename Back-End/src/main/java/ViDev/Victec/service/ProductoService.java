...
public class ProductoService {
    ...
    private void loadMockData() {
        ...
        // 2. --- ¡CAMBIO A HashSet! ---
        audifonos.setEspecificaciones(new HashSet<>());
        audifonos.setComentarios(new HashSet<>());
    ...
    public Producto saveProducto(Producto producto) {
        ...
        if (producto.getEspecificaciones() == null) {
            // 3. --- ¡CAMBIO A HashSet! ---
            producto.setEspecificaciones(new HashSet<>());
        }
        if (producto.getComentarios() == null) {
            // 4. --- ¡CAMBIO A HashSet! ---
            producto.setComentarios(new HashSet<>());
        }
